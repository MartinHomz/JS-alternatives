(function() {
  ...
  BubbleSort = function(a) {
    ...
    for (i = k = 0, ref = a.length; (0 <= ref ? k <= ref : k >= ref); i = 0 <= ref ? ++k : --k) {
      results.push((function() {
        var l, ref1, results1;
        results1 = [];
        for (j = l = 0, ref1 = a.length - i; (0 <= ref1 ? l <= ref1 : l >= ref1); j = 0 <= ref1 ? ++l : --l) {
          if (a[j] > a[j + 1]) {
            temp = a[j];
            a[j] = a[j + 1];
            results1.push(a[j + 1] = temp);
          } else {
  ...
  window.CaesarCipherClick = function() {
    var end, start, text, zprava;
    ...
    start = new Date().getTime();
    zprava = CaesarCipher(text);
    end = new Date().getTime();
    console.log(zprava);
    return console.log(end - start);
  };

  CaesarCipher = function(text) {
    var i, index, k, ref, zprava;
    zprava = "";
    for (index = k = 0, ref = text.length; (0 <= ref ? k <= ref : k >= ref); index = 0 <= ref ? ++k : --k) {
      i = text.charCodeAt(index);
      i += 1;
      zprava += String.fromCharCode(i);
    }
    return zprava;
  };

  window.IsPrimeClick = function() {
    var end, num, prime, start;
    num = parseInt(document.getElementById("strPrimeNumber").value);
    start = new Date().getTime();
    prime = IsPrime(num);
    end = new Date().getTime();
    console.log(prime);
  ...
  IsPrime = function(number) {
    ...
    boundary = Math.round(Math.sqrt(number));
    for (i = k = 3, ref = boundary; k <= ref; i = k += 2) {
      if (number % 1 === 0) {
        return false;
      }
    }
  ...
  window.SerializeClick = function() {
    var end, sklad, start;
    sklad = new Sklad("Sklad Nice", "Broumov");
    sklad.Polozky = [new Polozka("Telefon", "Samsung", 9999, "lorem ipsum dolor sit amet"), new Polozka("Mobil", "Gogen", 99959, "lorem ipsum dolor sit amet"), new Polozka("Televize", "Misc", 99919, "lorem ipsum dolor sit amet"), new Polozka("Sluchátka", "Kasper", 92999, "lorem ipsum dolor sit amet"), new Polozka("Hodinky", "Sims", 39999, "lorem ipsum dolor sit amet"), new Polozka("Křeslo", "Sins", 99699, "lorem ipsum dolor sit amet"), new Polozka("Pohovka", "Mob", 99799, "lorem ipsum dolor sit amet"), new Polozka("Míč", "Mose", 99599, "lorem ipsum dolor sit amet"), new Polozka("Auto", "Kali", 98999, "lorem ipsum dolor sit amet"), new Polozka("Kolo", "Lika", 99399, "lorem ipsum dolor sit amet"), new Polozka("Nákladní vůz", "Mins", 99929, "lorem ipsum dolor sit amet"), new Polozka("Topení", "Uks", 9991109, "lorem ipsum dolor sit amet"), new Polozka("Mikrofón", "GL", 99299, "lorem ipsum dolor sit amet"), new Polozka("Reproduktor", "Pear", 99599, "lorem ipsum dolor sit amet"), new Polozka("Tranzistor", "Mapple", 999, "lorem ipsum dolor sit amet"), new Polozka("Chléb", "Bimbows", 99, "lorem ipsum dolor sit amet"), new Polozka("Čaj", "Gas", 99, "lorem ipsum dolor sit amet"), new Polozka("Sushi", "Mos", 99, "lorem ipsum dolor sit amet"), new Polozka("Sušenka", "Top", 999, "lorem ipsum dolor sit amet"), new Polozka("Letadlo", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Hračka", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Helikoptéra", "Sput", 99949, "lorem ipsum dolor sit amet"), new Polozka("Telefon", "Samsung", 9999, "lorem ipsum dolor sit amet"), new Polozka("Mobil", "Gogen", 99959, "lorem ipsum dolor sit amet"), new Polozka("Televize", "Misc", 99919, "lorem ipsum dolor sit amet"), new Polozka("Sluchátka", "Kasper", 92999, "lorem ipsum dolor sit amet"), new Polozka("Hodinky", "Sims", 39999, "lorem ipsum dolor sit amet"), new Polozka("Křeslo", "Sins", 99699, "lorem ipsum dolor sit amet"), new Polozka("Pohovka", "Mob", 99799, "lorem ipsum dolor sit amet"), new Polozka("Míč", "Mose", 99599, "lorem ipsum dolor sit amet"), new Polozka("Auto", "Kali", 98999, "lorem ipsum dolor sit amet"), new Polozka("Kolo", "Lika", 99399, "lorem ipsum dolor sit amet"), new Polozka("Nákladní vůz", "Mins", 99929, "lorem ipsum dolor sit amet"), new Polozka("Topení", "Uks", 9991109, "lorem ipsum dolor sit amet"), new Polozka("Mikrofón", "GL", 99299, "lorem ipsum dolor sit amet"), new Polozka("Reproduktor", "Pear", 99599, "lorem ipsum dolor sit amet"), new Polozka("Tranzistor", "Mapple", 999, "lorem ipsum dolor sit amet"), new Polozka("Chléb", "Bimbows", 99, "lorem ipsum dolor sit amet"), new Polozka("Čaj", "Gas", 99, "lorem ipsum dolor sit amet"), new Polozka("Sushi", "Mos", 99, "lorem ipsum dolor sit amet"), new Polozka("Sušenka", "Top", 999, "lorem ipsum dolor sit amet"), new Polozka("Letadlo", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Hračka", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Helikoptéra", "Sput", 99949, "lorem ipsum dolor sit amet"), new Polozka("Telefon", "Samsung", 9999, "lorem ipsum dolor sit amet"), new Polozka("Mobil", "Gogen", 99959, "lorem ipsum dolor sit amet"), new Polozka("Televize", "Misc", 99919, "lorem ipsum dolor sit amet"), new Polozka("Sluchátka", "Kasper", 92999, "lorem ipsum dolor sit amet"), new Polozka("Hodinky", "Sims", 39999, "lorem ipsum dolor sit amet"), new Polozka("Křeslo", "Sins", 99699, "lorem ipsum dolor sit amet"), new Polozka("Pohovka", "Mob", 99799, "lorem ipsum dolor sit amet"), new Polozka("Míč", "Mose", 99599, "lorem ipsum dolor sit amet"), new Polozka("Auto", "Kali", 98999, "lorem ipsum dolor sit amet"), new Polozka("Kolo", "Lika", 99399, "lorem ipsum dolor sit amet"), new Polozka("Nákladní vůz", "Mins", 99929, "lorem ipsum dolor sit amet"), new Polozka("Topení", "Uks", 9991109, "lorem ipsum dolor sit amet"), new Polozka("Mikrofón", "GL", 99299, "lorem ipsum dolor sit amet"), new Polozka("Reproduktor", "Pear", 99599, "lorem ipsum dolor sit amet"), new Polozka("Tranzistor", "Mapple", 999, "lorem ipsum dolor sit amet"), new Polozka("Chléb", "Bimbows", 99, "lorem ipsum dolor sit amet"), new Polozka("Čaj", "Gas", 99, "lorem ipsum dolor sit amet"), new Polozka("Sushi", "Mos", 99, "lorem ipsum dolor sit amet"), new Polozka("Sušenka", "Top", 999, "lorem ipsum dolor sit amet"), new Polozka("Letadlo", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Hračka", "Sput", 999, "lorem ipsum dolor sit amet"), new Polozka("Helikoptéra", "Sput", 99949, "lorem ipsum dolor sit amet")];
    start = new Date().getTime();
    window.Json = JSON.stringify(sklad);
    end = new Date().getTime();
    console.log(window.Json);
    return console.log(end - start);
  };

  window.Deserialize = function() {
    var end, sklad, start;
    start = new Date().getTime();
    sklad = JSON.parse(window.Json);
    end = new Date().getTime();
  ...
  window.Generate = function() {
    var elements, end, k, l, start, x, y;
  ...
  Sklad = (function() {
    ...
    Sklad.prototype.Polozky = [];

    return Sklad;

  }).call(this);

  Polozka = class Polozka {
    constructor(Nazev, Vyrobce, Cena, Popis) {
      this.Nazev = Nazev;
